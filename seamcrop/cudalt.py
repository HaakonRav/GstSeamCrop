...
# ----- TESTING ------ REMOVE IF SEAMCROPCUDA WORKS
# generate the command to compile the linkable object with -dlink for shared library
# Currently overwrites the old object.
#args = sys.argv[2:4]
#args.extend(["-Xcompiler", "-fPIC","-dlink"]) # position indep code
#args.append("-o")
# Makes a separate file, rather than overwriting.
#args.append(pic_filepath[0:len(pic_filepath)-2]+"_link.o")
#args.append(pic_filepath)
#args.append(pic_filepath)
#args.extend(["-lcudart","-lcudadevrt"])
#command = " ".join(args)
#print command
